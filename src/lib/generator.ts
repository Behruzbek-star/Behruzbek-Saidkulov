...
const QUIZ_BANK: BankQuestion[] = [
  ...
  },
  {
    id: 'u2-9',
    topic: 'General Insurance',
    prompt: 'Allison’s auto insurance policy is due on the 10th of each month. Ever since she has had the policy, she has sent the premium in on the 16th of the month. The insurer has been accepting the premium this way for the past 5 years. A new CEO takes over and decides to cancel Allison’s policy for a nonpayment of premium. Allison contests this decision and legally gets the policy reinstated. The decision to reinstate the policy is an example of',
  ...
  },
  {
    id: 'u3-3',
    topic: 'Property and Casualty Insurance Basics',
    prompt: 'Which of the following terms describes the person listed first on the declarations page of a policy when there is more than one named insured?',
  ...
  },
  {
    id: 'u3-4',
    topic: 'Property and Casualty Insurance Basics',
    prompt: 'Greg’s policy states that a loss will not be covered unless it occurs within the United States or Canada. What is the name of this provision in his policy?',
  ...
  },
  {
    ...
    prompt: 'Todd and Mary have insurance protection for their home with a policy deductible of $500. One night, a thunderstorm knocks a tree onto their roof and causes $2,500 in damage. How much money will the insurance company pay to Todd and Mary to fix their roof?',
  ...
  },
  {
    id: 'u4-4',
    topic: 'Homeowners (2011) Policy',
    prompt: 'When a semi truck hit Greg’s house, he and his family had to stay in a nearby hotel for two weeks while repairs were being made. The hotel bill came to $1,000, and the cost of food came to $415. What was the indirect loss?',
  ...
  },
  {
    id: 'u4-5',
    topic: 'Property and Casualty Insurance Basics',
    prompt: 'The term that describes the absences of both people and property from the premises is',
  ...
  },
  {
    id: 'u4-6',
    topic: 'Property and Casualty Insurance Basics',
    prompt: 'Which of the following coverages insures against all risks of direct physical loss that are not specifically excluded in the policy?',
  ...
  },
  {
    id: 'u4-7',
    topic: 'Property and Casualty Insurance Basics',
    prompt: 'Timothy has an antique boat, and it was recently damaged while on a fishing trip. The insurance company agreed to repair the boat with less expensive, working materials. This is an example of which type of claim settlement?',
  ...
  },
  {
    id: 'u4-9',
    topic: 'Property and Casualty Insurance Basics',
    prompt: 'Which of the following terms describes a single limit of insurance that applies to all items of that property type?',
  ...
  },
  {
    id: 'u5-5',
    topic: 'General Insurance',
    prompt: 'Lee sues Matthew for injuries that she sustained in an automobile accident. During the trial, it is determined that Lee’s negligence contributed to 25% of the loss. Under comparative negligence laws,',
  ...
  },
  {
    id: 'u5-7',
    topic: 'General Insurance',
    prompt: 'Morgan, who has a liability policy with ABC Insurance, is playing golf with his daughter and hits a drive through the bedroom window of a neighbor, Tom. In this example, the first party to the loss is',
  ...
  },
  {
    id: 'u5-9',
    topic: 'General Insurance',
    prompt: 'If the courts feel that an individual acted willfully in causing an injured party’s damages, it may award',
